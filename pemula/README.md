...
5. [modul-05-web-security-dasar](./modul-05-web-security-dasar.md) — Dasar keamanan web: HTTP, auth, XSS, injection, CORS, CSP, dan WAF.
6. [modul-06-cloud-security-dasar](./modul-06-cloud-security-dasar.md) — Dasar cloud security: IAM, jaringan virtual, KMS, logging, IaC, dan guardrails.
